...
<ul class="list-inline nav-gallery" data-dir="#nav-{$list_dir}">
  ...
  <notempty name="feifei.nav_son">
    <volist name="feifei.nav_son" id="feifeison">
    <eq name="feifeison.nav_target" value="1">
      <li class="gallery-cell" id="nav-{$feifei.nav_tips}"><a href="{$feifeison.nav_link}" target="_blank">{$feifeison.nav_title}</a></li>
     <else/>
      <li class="gallery-cell" id="nav-{$feifei.nav_tips}"><a href="{$feifeison.nav_link}">{$feifeison.nav_title}</a></li>
     </eq>
    </volist>
  <else/>
     <eq name="feifei.nav_target" value="1">
      <li class="gallery-cell" id="nav-{$feifei.nav_tips}"><a href="{$feifei.nav_link}" target="_blank">{$feifei.nav_title}</a></li>
    <else/>
      <li class="gallery-cell" id="nav-{$feifei.nav_tips}"><a href="{$feifei.nav_link}">{$feifei.nav_title}</a></li>
    </eq>
  </notempty>
  </volist>
</ul>
