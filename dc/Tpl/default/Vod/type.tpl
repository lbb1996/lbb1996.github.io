...
<div class="container ff-bg">
  ...
  <div class="clearfix ff-clearfix"></div>
  <script>
	$("#id{$type_id|md5}").removeClass("btn-default").addClass("btn-success gallery-active");
	$("#type{$type_type|md5}").removeClass("btn-default").addClass("btn-success gallery-active");
	$("#area{$type_area|md5}").removeClass("btn-default").addClass("btn-success gallery-active");
	$("#year{$type_year|md5}").removeClass("btn-default").addClass("btn-success gallery-active");
	$("#star{$type_star|md5}").removeClass("btn-default").addClass("btn-success gallery-active");
	$("#state{$type_state|md5}").removeClass("btn-default").addClass("btn-success gallery-active");
