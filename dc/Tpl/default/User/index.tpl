...
<div class="row">
  ...
  <div class="col-xs-12 ff-col">
    <div class="page-header">
      <h4><span class="glyphicon glyphicon-menu-right ff-text"></span> {$user_name|htmlspecialchars|nb}喜欢的影片</h4>
    </div>
    <php>
$item_vod = ff_mysql_record('sid:1;uid:'.$user_id.';type:3;group:record_did;limit:24;cache_name:default;cache_time:default;order:record_id;sort:desc');
  ...
  <div class="col-xs-12 ff-col">
    <div class="page-header">
      <h4><span class="glyphicon glyphicon-menu-right ff-text"></span> {$user_name|htmlspecialchars|nb}想看的影片</h4>
    </div>
    <php>
$item_vod = ff_mysql_record('sid:1;uid:'.$user_id.';type:4;group:record_did;limit:24;cache_name:default;cache_time:default;order:record_id;sort:desc');
  ...
  <div class="col-xs-12 ff-col">
    <div class="page-header">
      <h4><span class="glyphicon glyphicon-menu-right ff-text"></span> {$user_name|htmlspecialchars|nb}在看的影片</h4>
    </div>
    <php>
$item_vod = ff_mysql_record('sid:1;uid:'.$user_id.';type:5;group:record_did;limit:24;cache_name:default;cache_time:default;order:record_id;sort:desc');
  ...
  <div class="col-xs-12 ff-col">
    <div class="page-header">
      <h4><span class="glyphicon glyphicon-menu-right ff-text"></span> {$user_name|htmlspecialchars|nb}看过的影片</h4>
    </div>
    <php>
