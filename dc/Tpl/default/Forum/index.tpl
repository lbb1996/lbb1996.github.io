<php>$item_list = ff_mysql_forum('pid:0;limit:30;status:1;page_is:true;page_id:forum;page_p:'.$forum_page.';cache_name:default;cache_time:default;order:forum_addtime;sort:desc');
...
<div class="page-header">
  ...
  <a href="{:ff_url('forum/index', array('p'=>1), true)}">评论版块</a>
  </h2>
</div>
<ul class="list-unstyled">
  <li>
    <h5><a class="ff-text" href="{:ff_url('forum/guestbook',array('p'=>1),true)}">网站留言</a></h5>
  	<p class="text-muted">{$site_name}交流平台，通过此窗口将您的建议与反馈告诉我们吧，当然也可以通过此版块给我们投稿，小编随时恭候您的调侃。</p>
  </li>
	<li>
